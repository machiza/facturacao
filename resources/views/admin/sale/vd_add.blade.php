...
@section('content')
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form action="{{url('sales/save_vd')}}" method="POST" id="salesForm">  
          <!-- situacao do clinete -->
           ...
           <div class="col-md-3">
              <div class="form-group">
                  ...
                  <div class="input-group">
                     <div class="input-group-addon">VD-</div>
        ...
        <input type="hidden" name="paymntFor" value="Payment for VD-{{ sprintf("%04d", $invoice_count+1)}}/<?php echo $parte_ano;?>">
