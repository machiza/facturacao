...
<body onload="habilitaClinvoices()"></body>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
         <h4 class="text-info">Nota Credito # <a href="{{url('/invoice/view-detail-invoice-credito/'.$CreditoData->credit_no)}}">{{$CreditoData->reference_credit}}</a></h4>
        <div class="clearfix"></div>
        <form action="{{url('sales/updatecredito')}}" method="POST" id="salesForm">  
        ...
        <input type="number" id="contagem" value="" hidden>
        <input type="number" id="credito" name="credito" value="{{$CreditoData->credit_no}}" hidden>
          ...
          <div class="col-md-3">
              <div class="form-group">
                ...
                @foreach($customerData  as $key => $data)
                      @if($CreditoData->debtor_no_credit== $data->debtor_no)
            ...
            <div class="col-md-3">
              <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     <input type="hidden" name="reference_credit" id="reference_no_write" value="{{$CreditoData->reference_credit}}">
                  </div>
                  <span id="errMsg" class="text-danger"></span>
              </div>
            </div>
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                  ...
                  <tr class="tbl_header_color dynamicRows">
                    ...
                    $subTotalAmount = 0;
                  ?>
                  @if(count($CreditoDetalhes)>0)
                    @foreach($CreditoDetalhes as $result)
                        <?php
