      ...
      <div class="box">
            <!-- /.box-header -->
             ...
             <div class="box-header">
              <a id="report" target="_blank" href="{{ url('credito-report') }}"> <button class="btn btn-default btn-flat"><span class="fa fa-print"> &nbsp;</span>{{ trans('message.sidebar.report') }}</button></a>
           </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($cotacoes as $cotacao)
                       <tr>
                       <td class="{{ $cotacao->credit_date }}">{{ formatDate($cotacao->credit_date) }}</td>
                      <td>
                    ...
                    @php
                      $semIva = $cotacao->credito - $cotacao->tax_total;
                      $totalSIva += $semIva;
                      $total_tax += $cotacao->tax_total;
                      $total += $cotacao->credito;
                    @endphp
                     <td><?php echo Session::get('currency_symbol').number_format($semIva,2); ?></td>
                     <td><?php echo Session::get('currency_symbol').number_format($cotacao->tax_total,2); ?></td>
                  ...
                  <tr>
                    <td ></td>
                      <td></td>
                       ...
                       <td><strong><?php echo Session::get('currency_symbol').number_format("$total",2); ?></td>
                      <td ><strong>
                      </td>
                  </tr>
                  {{-- @endif --}}
...
@section('js')
  <script type="text/javascript">
    ...
    $('#Rfiltro').click(function() {
      ...
      $("#report").attr("href", SITE_URL+"/credito-report/"+di+"/"+df+"/"+clienteId);
