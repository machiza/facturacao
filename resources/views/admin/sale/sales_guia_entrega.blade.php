    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-header">
          <a id="report" target="_blank" href="{{ url('guiaentrega-report') }}"> <button class="btn btn-default btn-flat"><span class="fa fa-print"> &nbsp;</span>{{ trans('message.sidebar.report') }}</button></a>
        </div>
              ...
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($guias as $guia)           
                    <tr>
                      <td class="{{ $guia->ge_date }}">{{ formatDate($guia->ge_date) }}</td> 
                      <td>
...
@section('js')
  <script type="text/javascript">
    ...
    $('#Rfiltro').click(function() {
      ...
      $("#report").attr("href", SITE_URL+"/guiaentrega-report/"+di+"/"+df+"/"+clienteId);
