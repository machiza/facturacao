...
@section('content')
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form action="{{url('sales/save_ge')}}" method="POST" id="geForm">  
          ...
          <div class="col-md-3">
              <div class="form-group">
                  ...
                  <!--<div class="input-group">
                     ...
                     <input id="reference_no" class="form-control" name="ge_ref" value="GE-{{ sprintf("%04d", $invoice_count+1)}}/<?php echo $parte_ano;?>" type="text" readonly>
            ...
            <div class="col-md-3">
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="local_entrega">
              </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="carta">
              </div>
            </div>            
            <div class="col-md-3">
              <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>{{ trans('message.form.data_entrega') }}<span class="text-danger"> *</span></label>
                  <input class="form-control" id="datepicker" type="text" name="ge_date" value="<?php echo $data_final;?>" readonly>
              </div>
       ...
       console.log(e);
                ...
                /*
                   ...
                   var   subTotalAmount = 0;
                            ...
                            priceAmount = (e.quantity*e.unit_price);
                            discount = (e.priceAmount*e.discount_percent)/100;
                            newPrice = ($priceAmount-$discount);
                            tax = (newPrice*e.tax_rate/100);
                            subTotalAmount += newPrice;
                            taxTotal += tax;
                             
                             if(e.taxa_inclusa_valor=='no'){
                                preco=e.unit_price;
                             }else{

                                precoDesconto=(newPrice/e.quantity)+tax;
                                //$preco=$result->unit_price;
                                Des=1-e.discount_percent/100;
               ...
               if(e.is_inventory == 1){
               '<tr id="rowide.item_id" class="linha">'+
                '<input type="hidden" name="stock_id[]" value="'+e.stock_id+'">'+
               '<input type="hidden" name="item_rowid[]" value="'+e.id+'">'+
                '<td class="text-center">'+e.description+'<input type="hidden" name="description[]" value="'+e.description+'"></td>'+
                '<td> <input class="form-control text-center unidades no_units" min="0" data-id="'+e.item_id+'" data-rate="'+e.unit_price+'" id="qty_"'+e.item_id+'" name="item_quantity[]" value="'+e.quantity+'" type="text"><input type='hidden' name='item_id[]' value="'+e.item_id+'"></td>'+
                '<td class="text-center">'+
                  '<input min="0" class="form-control text-center unitprice percentagem" name="unit_price[]" data-id="'+e.item_id+'" id="rate_id_"'+e.item_id+'" value="'+preco+'" type="text">'+
                  '<input type='hidden' name='type[]' value='0'>'+
                '</td>'+

              '<td class="text-center">'+
                '<select class="form-control taxList taxa" name="tax_id[]">'+e.tax_type_id+'</select>
              </td>'+
              '<td class="text-center taxAmount">'+tax+'</td>'+
              '<td class="text-center">'+
                if(e.taxa_inclusa_valor=='no'){
                '<input type="checkbox" value="" name="inclusao[]" data-input-id_check="'+e.item_id+'" class="inclusaos checkitem" value="zero"><input class="pegar" type="hidden" value="no" name="taxainclusa[]">'+
                }else
             ...
             <tr id="rowid{{$result->item_id}}" class="linha">
              ...
              <td class='text-center taxAmount'>tax,2,'.','')</td>
