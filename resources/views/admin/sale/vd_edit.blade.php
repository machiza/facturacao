  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <h4 class="text-info">VENDA DIRECTA# <a href="{{url('/invoice/view-detail-vd/'.$inoviceInfo->vd_no)}}">{{$inoviceInfo->reference_vd}}</a></h4>
            <div class="clearfix"></div>
        <form action="{{url('sales/update_vd')}}" method="POST" id="salesForm">  
          <!-- situacao do clinete -->
          ...
          <input type="text" id="vd_id" name="vd_id" value="{{$inoviceInfo->vd_no}}" hidden>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                @foreach($customerData as $data)
                  @if($inoviceInfo->debtor_no_vd==$data->debtor_no)
           ...
           <div class="col-md-3">
              <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     <input id="reference_no" class="form-control" value="{{$inoviceInfo->reference_vd}}" type="text" readonly>
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">{{ trans('message.extra_text.payment_method') }}<span class="text-danger"> *</span></label>
                    ...
                    @foreach($payments as $payment)
                      ...
                      @if($inoviceInfo->payment_id==$payment->id)
              ...
              <div class="form-group">
                <label for="inputEmail3">{{ trans('message.bank.account') }}<span class="text-danger"> *</span></label>
                  ...
                  @foreach($accounts as $acc_no=>$acc_name)
                     @if($inoviceInfo->account_no==$acc_no)
                          <option value="{{$acc_no}}" selected="">{{$acc_name}}</option>
                    @else
        ...
        <input type="hidden" name="paymntFor" value="Payment for VD-{{$inoviceInfo->reference_vd}}">
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <a href="{{url('/sales/vd')}}" class="btn btn-info btn-flat">{{ trans('message.form.cancel') }}</a>
