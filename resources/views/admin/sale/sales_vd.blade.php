    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-body">
          <div class="row">
                    <div class="col-md-10">
                        <div class="top-bar-title padding-bottom">Venda Dinheiro</div>
                    </div> 
                    <div class="col-md-2">
                     ...
                     @if(Helpers::has_permission(Auth::user()->id, 'delete_invoice'))
                        <td>
                            ...
                            {!! csrf_field() !!}
                               ...
                               <a title="edit" class="btn btn-xs btn-primary"  href="{{url("sales/vd/$venda->vd_no/edit")}}"><span class="fa fa-edit"></span></a>
                          </td> 
                      @endif
