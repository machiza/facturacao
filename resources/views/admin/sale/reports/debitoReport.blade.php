...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <title>{{ trans('message.invoice_pdf.debit_report')}}</title>
...
<body>
  ...
  <div style="width:400px; float:right; margin-top:10px;height:40px;">
    <div style="font-size:20px; font-weight:bold; color:#383838;">
      <span>{{ trans('message.invoice_pdf.debit_report') }}</span><br>
    ...
    @foreach($debitos as $data)
      <tr style="background-color:#fff; text-align:center; font-size:13px; font-weight:normal;">
        ...
        @php
          ...
          $totalComIva += $data->debito;
          $total_tax += $data->tax_total;
          $valorSemIva = $data->debito - $data->tax_total;
        ...
        <td style="padding-right:1px;text-align:justify; color: #000000">
          <?php echo Session::get('currency_symbol').number_format($data->debito,2); ?>
        </td>
      </tr>
    @endforeach
    <tr style="background-color:#fff; text-align:center; font-size:13px; font-weight:normal;">
