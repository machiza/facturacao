...
<body onload="habilitaClinvoices()"></body>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form action="{{url('sales/updatedebito')}}" method="POST" id="salesForm">  
        ...
        <input type="number" id="contagem" value="" hidden>
        <input type="number" id="debito" name="debito" value="{{$DebitoData->debit_no}}" hidden>
          ...
          <div class="col-md-3">
              <div class="form-group">
                ...
                @foreach($customerData  as $key => $data)
                      @if($DebitoData->debtor_no_debit== $data->debtor_no)
        ...
        <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                  ...
                  <div class="input-group">
                     <div class="input-group-addon">ND-</div>
                     <input id="reference_no" class="form-control" value="{{ sprintf("%04d", $invoice_count+1)}}/<?php echo $parte_ano;?>" type="text" readonly>
                     <input type="hidden" name="reference_debit" id="reference_no_write" value="{{$DebitoData->reference_debit}}">
                  </div>
                  <span id="errMsg" class="text-danger"></span>
              </div>
            </div>
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                  ...
                  @if(count($DebitoDetalhes)>0)
                    @foreach($DebitoDetalhes as $result)
                        <?php
