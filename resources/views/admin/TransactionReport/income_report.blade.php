    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
             <div class="top-bar-title padding-bottom">{{ trans('message.transaction.income_report') }}</div>
            </div>
          </div>
        </div>
      </div>
...
@section('js')
    ...
    $("#year").on("change", function(){
      var year = $(this).val();
      window.location = SITE_URL+"/transaction/income-report?year="+year;
    });
...
Highcharts.chart('container', {
    ...
    title: {
        text: '{{ trans('message.transaction.income_report') }}'
    },
    subtitle: {
        text: ''
    },
    ...
    tooltip: {
        pointFormat: 'Income: <b>{point.y:.2f}</b>'
    },
    series: [{
        name: 'Income',
