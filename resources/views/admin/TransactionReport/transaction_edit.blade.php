...
@section('content')
    ...
    <div class="box box-default">
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
           <div class="top-bar-title padding-bottom">{{ trans('message.transaction.transaction_single') }}</div>
          </div> 
        </div>
      </div>
    </div>
    ...
    <div class="box">
      <div class="box-body">
        <h4 class="text-info text-center">{{ trans('message.transaction.edit_transaction') }}</h4>
          <!-- form start -->
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="number" placeholder="{{ trans('message.table.amount') }}" class="form-control" id="amount" name="amount" min="0" value="{{$depositInfo->amount}}">
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-6 col-sm-offset-3">
             <div style="margin-top:10px;"> 
                <a href="{{ url('transction/list') }}" class="btn btn-info btn-flat">{{ trans('message.form.cancel') }}</a>
