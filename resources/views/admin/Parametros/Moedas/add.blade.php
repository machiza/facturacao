      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <form action="{{ url('cambio/save') }}" method="post" id="conta" class="form-horizontal">
            ...
            <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="nome" placeholder="Ex: MZN" id="nome" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="singular" placeholder="Ex: Metical" id="singular" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="plural" placeholder="Ex: Meticais" id="plural" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="casas_decimais_sing" placeholder="Ex: Centavo" id="casas_decimais_sing" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="casas_decimais_plu" placeholder="Ex: Centavos" id="casas_decimais_plu" class="form-control">
