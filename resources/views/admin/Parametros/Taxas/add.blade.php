...
@section('content')
    ...
    <section class="content">
      ...
      <div class="row">
      <div class="col-md-4">
          @include('layouts.includes.taxa_menu')
        </div>
        <!-- /.col -->
        <div class="col-md-8">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Adicionar Taxa</h3>
            </div>
            
            <form action="{{ url('taxas/save') }}" method="post" id="conta" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6"> 
                                          <select class="form-control select2" name="moedas_id" id="moedas_id">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="compra" id="compra" placeholder="Ex: 61,2"  class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="venda" id="venda" placeholder="Ex: 62,42"  class="form-control">
