...
<head>
    ...
    <title>{{ trans('message.quotation.sales_orders') }}</title>
...
<div style="width:200px; float:right; margin-top:10px;height:50px;">
  ...
  <!--div style="clear:both;"></div-->
   ...
   <div style="width:400px; float:right;font-size:15px; color:#383838; font-weight:400; border-bottom:#000000; ">
      ...
      <div><strong>Cotação a </strong></div>
  ...
  <div style="margin-top:30px;">
   ...
   <table style="width:100%; border-radius:2px;  ">
    ...
    <tr style="background:#cdcdcd;text-align:center; font-size:13px; font-weight:bold;">
      ...
      <td style="padding-right:1px;text-align:center; color: #000000">{{ trans('message.quotation.price') }}($)</td>
     ...
     <footer class="footer1">
      ...
      <table class="tablefooter">
          <tr style="background-color:#f0f0f0; border-bottom:2px solid #006DEF; text-align:center; font-size:12px; font-weight:bold;">
            <th style="border-bottom:1px solid #000000">Dados bancarios - BCI</th>
          ...
          <tr style="font-size:10px">
            <td>NIB 000800003440658010180</td>
