...
<body>
   ...
   <img src="{{asset('img/logo.png')}}" width="200">
        ...
        <div style="width:300px; float:right; margin-top:10px;height:40px;">
            ...
            <div>
                <strong>#   {{ !empty($saleDataOrder->reference_debit) ? $saleDataOrder->reference_debit : ''}}</strong>
            </div>
           

            
             <div>Data:{{formatDate($SaleDebito->debit_date)}}</div>
            
            
            <div>
               
              <h5>Factura relacionada:({{!empty($saleDataOrder->reference) ? $saleDataOrder->reference : ''}} )</h5>
            </div>
  ...
  @endforeach  
    ...
    <tr style="background-color:#cdcdcd; text-align:right; font-size:13px; font-weight:normal;">
      <td colspan="5" style="text-align:right;border-bottom:none; color: #000000;background:#ffffff;">
...
<body>
   ...
   <img src="{{asset('img/logo.png')}}" width="200">
        ...
        <div style="width:300px; float:right; margin-top:10px;height:40px;">
            ...
            <div>
                <strong># <?php echo" ". $d_ref;?>
                 </strong>
            </div>
            
             <div>Data: <?php echo $data_debito;?></div>
            
            
            <div>
               
                <h5>Factura relacionada:{{!empty($saleDataInvoice->reference) ? $saleDataInvoice->reference : ''}} )</h5>
            </div>
