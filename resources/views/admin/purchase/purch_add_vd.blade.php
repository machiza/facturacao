...
@section('content')
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form action="{{url('purchase/save_vd')}}" method="POST" id="purchaseForm">  
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input class="form-control" id="datepicker" type="text" name="ord_date" readonly>
                </div>
                <!-- /.input group -->
              </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="box-header text-center">
                <h3 class="box-title"><b>{{ trans('message.form.purchase_vd_items') }}</b></h3>
              </div>
              <!-- /.box-header -->
              ...
              <div class="form-group">
                ...
                <div class="box-footer">
                    <a href="{{ url('purchase/vd') }}" class="btn btn-info btn-flat">{{ trans('message.form.cancel') }}</a>
