 ...
 <!-- Default box -->
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="{{url('payment/save_newpayment')}}" name="myform" novalidate method="POST" id="payForm">  
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <option value="{{$cat_id}}"  <?= ($cat_id ==0 ? 'selected':'')?>>{{$cat_name}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="row"><br>
            ...
            <div class="col-md-3">
              ...
              <span style="color:red" class="customerVal" hidden>Required</span>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                ...
                <button type="submit" name="btn_newpayment" class="btn btn-primary btn-flat pull-right btnSubmit" id="btnSubmit">
...
@section('js')
<script src="{{asset('public/dist/js/paymentNew.js')}}"></script>
