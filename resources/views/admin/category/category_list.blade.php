            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ $data->name }}</td>
                  <td>
                  @if(Helpers::has_permission(Auth::user()->id, 'edit_item_category') && !in_array($data->category_id,[1]))
                  ...
                  @if(Helpers::has_permission(Auth::user()->id, 'delete_item_category') && !in_array($data->category_id,[1]))
