    ...
    <section class="content">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-8 col-sm-4 col-xs-12">
             <div class="top-bar-title padding-bottom">{{ trans('message.table.item_service') }}</div>
            </div> 
      ...
      <div class="box">
            ...
            <div class="box-header">
              <a href="{{ URL::to('itemdownloadcsv/xls') }}"><button class="btn btn-default btn-flat btn-border-info"><span class="fa fa-download"> &nbsp;</span>{{ trans('message.table.download_xls') }}</button></a>
            </div>
            ...
            <div class="box-body">
              <table id="itemList" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  @if(Helpers::has_permission(Auth::user()->id, 'edit_item'))
                  <a href="{{ url("edit-item/item-info/$data->item_id") }}">{{ $data->description }}</a>
                  @else
                  {{ $data->description }}
                  @endif
                  </td>
