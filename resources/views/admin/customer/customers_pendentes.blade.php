               ...
               @endphp
                ...
                @endphp
                      ...
                      @if($dado->status!='cancelado')
                        <tr>
                            ...
                            @php
                              ...
                              $sub_total = $sub_total + $dado->saldo_doc - $pago;
                              
                              if ($linha[0]=='NC') {
                                $saldo_doc = $dado->amount_credito_doc - $pago;
                              } else {
                                $saldo_doc = $dado->saldo_doc - $pago;
                              }
                  ...
                  <tr>
                    ...
                    <td>
                      <strong>{{ Session::get('currency_symbol').number_format($sub_total,2) }}</strong>
                    </td>                  
                  </tr> 
                  @php
                    $total += $sub_total;
