          ...
          <div class="box box-info">
            ...
            <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="email" value="{{isset($emailConfigData->smtp_email) ? $emailConfigData->smtp_email : ''}}" class="form-control" name="smtp_email">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="email" value="{{isset($emailConfigData->from_name) ? $emailConfigData->from_name : ''}}" class="form-control" name="from_name">
                  </div>
                </div>
                <div class="form-group">
