...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <title>{{ trans('message.invoice_pdf.supp_report') }}</title>
...
<body>
    <img src="{{asset('img/logo.png')}}" width="160">
      ...
      <div style="font-size:20px; font-weight:bold; color:#383838;">{{ trans('message.invoice_pdf.supp_report') }}</div>
    </div>
<div>
   ...
   <table style="width:100%; border-radius:2px;  ">
      ...
      <tr style="background-color:#f0f0f0; border-bottom:1px solid #d1d1d1; text-align:center; font-size:13px; font-weight:bold;">
          <th style="padding-right:1px;text-align:justify; color: #000000">
            {{ trans('message.sidebar.supplier') }}
          </th>
          <th style="padding-right:1px;text-align:justify; color: #000000">
            Nuit
          </th>
          ...
          <th style="padding-right:1px;text-align:justify; color: #000000">
            {{ trans('message.extra_text.phone') }}
          </th>
          <th style="padding-right:1px;text-align:justify; color: #000000">
            {{ trans('message.table.address') }}
          </th>
          
    </tr>

   @foreach($supplierData as $data)
    <tr style="background-color:#fff; text-align:right; font-size:13px; font-weight:normal;">
