...
// Abdul Sumail - 840302176 / 826215197 | abdulsumail@gmail.com
		...
		Route::get('debito-report/{from}/{to}/{customer}','DebitoController@reporteFilter');
		...
		Route::get('guiaentrega-report/{from}/{to}/{customer}','GEController@reporteFilter');
		Route::get('sales/guiaentrega/{id}/edit','GEController@edit');



		Route::get('guiatransporte-report','GTController@reporte');
		Route::get('guiatransporte-report/{from}/{to}/{customer}','GTController@reporteFilter');
		...
		Route::get('credito-report/{from}/{to}/{customer}','CreditoController@reporteFilter');
		...
		// create sales order
		Route::get('order/list','SalesOrderController@orderFiltering')->middleware(['permission:manage_quotation']);
		...
		Route::get('invoice/pdf-contacorrente-all','CustomerController@contacorrenteFilterPdfAll');
		Route::get('invoice/pdf-contacorrente/{order_id}/{from}/{to}','CustomerController@contacorrenteFilterPdf');
       ...
       //CREDITO
		...
		Route::get('customer/current_account_all','CustomerController@current_account_all');
		...
		Route::get('purchase/list','PurchaseController@Filtering')->middleware(['permission:manage_purchase']);
		...
		Route::get('purchase/report/{from}/{to}/{customer}','PurchaseController@reportFiltering');
		...
		Route::get('payment/report/{from}/{to}/{customer}','PaymentController@reportFilter');
		...
		Route::get('sales_orders-report/{from}/{to}/{customer}','SalesOrderController@reporte_pdf');
