...
class Purchase extends Model
{
    ...
    { 
        return $this->leftJoin('suppliers', 'purch_orders.supplier_id', '=', 'suppliers.supplier_id')
                    ...
                    ->select('purch_orders.*', 'suppliers.supp_name','suppliers.nuit','location.location_name as loc_name')
    ...
    public function getPurchaseInvoiceByID($id)
    {
          $data = DB::table('purch_order_details')
                ...
                ->select('purch_order_details.*', 'item_code.id as item_id','item_tax_types.tax_rate','item_tax_types.id as tax_id','purchase_prices.id')->orderBy('po_detail_item', 'ASC')
                ->get();
        return $data;
    }
