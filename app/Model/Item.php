...
class Item extends Model
{
    ...
    {
      $dad =  DB::select("SELECT ic.`stock_id`,ic.description as item_name,sc.description as category,pp.price as purcashe_price,rp.price as retail_price,wsp.price as wholesale_price, br.description as item_brand FROM `item_code` as ic
      LEFT JOIN stock_category as sc
      ON sc.`category_id` = ic.`category_id`
      
       LEFT JOIN brand as br
      ON br.id = ic.brand_id
