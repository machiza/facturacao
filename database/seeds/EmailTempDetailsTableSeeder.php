...
class EmailTempDetailsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $emailTemp[7]['subject'] = 'Payment information for Quotation#{order_reference_no} and Invoice#{invoice_reference_no}.';
        ...
        $emailTemp[14]['subject'] = 'Payment information for Quotation#{order_reference_no} and Invoice#{invoice_reference_no}.';
        ...
        $emailTemp[21]['subject'] = 'Your Invoice # {invoice_reference_no} for Quotation #{order_reference_no} from {company_name} has been created.';
        ...
        $emailTemp[35]['subject'] = 'Your Quotation # {order_reference_no} from {company_name} has been packed';
        $emailTemp[35]['body'] = 'Hi {customer_name},<br><br>Thank you for your order. Here’s a brief overview of your shipment:<br>Quotation # {order_reference_no} was packed on {packed_date}.<br> <br><b>Shipping address   </b><br><br>{shipping_street}<br>{shipping_city}<br>{shipping_state}<br>{shipping_zip_code}<br>{shipping_country}<br><br><b>Item Summery</b><br>{item_information}<br> <br>If you have any questions, please feel free to reply to this email.<br><br>Regards<br>{company_name}<br><br><br>';
